  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit fixed top-10 inset-x-0 mx-auto rounded-full bg-white dark:bg-black shadow-lg pr-2 pl-4 py-2 items-center justify-center space-x-2 z-[5000]",
          className
        )}
      >
