                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-sm text-[#1D3557]/80">GitHub</label>
                        {!isEditing ? (
                          <p className="text-[#1D3557]">
                            {profileData.socialLinks?.github ? `@${profileData.socialLinks.github}` : "Not linked"}
                          </p>
                        ) : (
                          <div className="flex">
                            <span className="bg-gray-100 px-2 py-2 rounded-l-lg border border-r-0 border-[#C5D7E5]">@</span>
                            <input
                              type="text"
                      ...
                      <div>
                        <label className="block text-sm text-[#1D3557]/80">GitLab</label>
                        {!isEditing ? (
                          <p className="text-[#1D3557]">
                            {profileData.socialLinks?.gitlab ? `@${profileData.socialLinks.gitlab}` : "Not linked"}
                          </p>
                        ) : (
                          <div className="flex">
                            <span className="bg-gray-100 px-2 py-2 rounded-l-lg border border-r-0 border-[#C5D7E5]">@</span>
                            <input
                              ...
                              value={editData.socialLinks?.gitlab || ""}
                              onChange={(e) => {
                                setEditData({
                                  ...editData,
                                  socialLinks: {
                      ...
                      <div>
                        <label className="block text-sm text-[#1D3557]/80">LinkedIn</label>
                        {!isEditing ? (
                          <p className="text-[#1D3557]">
                            {profileData.socialLinks?.linkedin ? `@${profileData.socialLinks.linkedin}` : "Not linked"}
                          </p>
                        ) : (
                          <div className="flex">
                            <span className="bg-gray-100 px-2 py-2 rounded-l-lg border border-r-0 border-[#C5D7E5]">@</span>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-sm text-[#1D3557]/80">LeetCode</label>
                        {!isEditing ? (
                          <p className="text-[#1D3557]">
                            {profileData.socialLinks?.leetcode ? `@${profileData.socialLinks.leetcode}` : "Not linked"}
                          </p>
                        ) : (
                          <div className="flex">
                            <span className="bg-gray-100 px-2 py-2 rounded-l-lg border border-r-0 border-[#C5D7E5]">@</span>
                            <input
                              ...
                              value={editData.socialLinks?.leetcode || ""}
                              onChange={(e) => {
                                setEditData({
                                  ...editData,
                                  socialLinks: {
                      ...
                      <div>
                        <label className="block text-sm text-[#1D3557]/80">CodeChef</label>
                        {!isEditing ? (
                          <p className="text-[#1D3557]">
                            {profileData.socialLinks?.codechef ? `@${profileData.socialLinks.codechef}` : "Not linked"}
                          </p>
                        ) : (
                          <div className="flex">
                            <span className="bg-gray-100 px-2 py-2 rounded-l-lg border border-r-0 border-[#C5D7E5]">@</span>
                      ...
                      <div>
                        <label className="block text-sm text-[#1D3557]/80">HackerRank</label>
                        {!isEditing ? (
                          <p className="text-[#1D3557]">
                            {profileData.socialLinks?.hackerrank ? `@${profileData.socialLinks.hackerrank}` : "Not linked"}
                          </p>
                        ) : (
                          <div className="flex">
                            <span className="bg-gray-100 px-2 py-2 rounded-l-lg border border-r-0 border-[#C5D7E5]">@</span>
                            <input
                              ...
                              value={editData.socialLinks?.hackerrank || ""}
                              onChange={(e) => {
                                setEditData({
                                  ...editData,
                                  socialLinks: {
                      ...
                      <div>
                        <label className="block text-sm text-[#1D3557]/80">CodeForces</label>
                        {!isEditing ? (
                          <p className="text-[#1D3557]">
                            {profileData.socialLinks?.codeforces ? `@${profileData.socialLinks.codeforces}` : "Not linked"}
                          </p>
                        ) : (
                          <div className="flex">
                            <span className="bg-gray-100 px-2 py-2 rounded-l-lg border border-r-0 border-[#C5D7E5]">@</span>
                      ...
                      <div>
                        <label className="block text-sm text-[#1D3557]/80">HackerEarth</label>
                        {!isEditing ? (
                          <p className="text-[#1D3557]">
                            {profileData.socialLinks?.hackerearth ? `@${profileData.socialLinks.hackerearth}` : "Not linked"}
                          </p>
                        ) : (
                          <div className="flex">
                            <span className="bg-gray-100 px-2 py-2 rounded-l-lg border border-r-0 border-[#C5D7E5]">@</span>
                            <input
                              type="text"
                              name="socialLinks.hackerearth"
                              value={editData.socialLinks?.hackerearth || ""}
                              onChange={(e) => {
                                setEditData({
                                  ...editData,
                                  socialLinks: {
